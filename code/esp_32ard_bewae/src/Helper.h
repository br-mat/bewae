...
namespace Helper{
    String timestamp();
    void shiftvalue8b(uint8_t val, bool invert = false); // set shift register to value (8 bit)
    void shiftvalue(uint32_t val, uint8_t numBits, bool invert = false); // set shift register with more bits (32 bit)
