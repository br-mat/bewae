...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//   global variable & pin definitions
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
#define esp_timeout 60000UL //time in ms
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//             Transistor pins
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
uint8_t q4_npn_ensh = A3; //Bipolar transistor enable for 74hc595 shiftregister (gnd npn NEVER SWITCH OFF)
...
int group_st_time[6]={120,30,5,30,70,0};//{180, 60, 5, 0, 120, 0}; //{630/3, 200/2, 18/3, 400/2, 320/2, 0 };
  ...
  */
  ...
  //if(true){
    ...
    if((hour1 == 11) | (hour1 == 18)){
      thirsty = true;
      //LATER! request or derive the watering amount!
    }
  }
  ...
  //if(true)
  {
    ...
    digitalWrite(esp_pdown,HIGH); //turn up esp and init the timeout
    // --- prepare for datalog ---
    digitalWrite(q4_npn_ensh, HIGH);  //activate shift register and set it all to zero
    shiftvalue8b(0);
    ...
    while((start_t+measure_intervall > millis()) & (thirsty)){
      ...
      for(uint8_t i=0; i<6; i++){
        ...
        if(water_timer != 0){
          ...
          //new attempt: sleep keep brown our detection on in case of problems with supply voltage so the system can reset
